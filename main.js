...
function startgame() {
  game_status = "start";
  document.getElementById("stus").innerHTML = "ready to begin";
}
...
function move() {
  ...
  if (pcscore == 4) {
    ...
    text("press try again button to play again", width / 2, height / 2 + 30)
    noLoop();
    pcscore = 0;
  }
